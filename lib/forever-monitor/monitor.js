...
var Monitor = exports.Monitor = function (script, options) {
    ...
    this.exposeGC = options.exposeGC;
    this.nouseIdleNotification = options.nouseIdleNotification;
...
Monitor.prototype.trySpawn = function () {
    ...
    if (this.nouseIdleNotification) {
        this.args.unshift('--nouse-idle-notification');
    }
